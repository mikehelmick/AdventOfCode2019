...
defmodule Puzzle do
  ...
  def split_input(str) do
    String.split(str, ",")
      |> Enum.map(
           fn x ->
             {num, _} = Integer.parse(String.slice(x, 1..-1))
             {String.slice(x, 0, 1), num}
           end)
  end
  ...
  def find_steps([{{_, _}, _}|rest], {x, y}), do: find_steps(rest, {x, y})
end
